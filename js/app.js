document.addEventListener('alpine:init', () => {
    Alpine.data('app', () => ({
        ...
        continueMondayBook: '',
        continueTuesdayBook: '',
        continueWednesdayBook: '',
        continueThursdayBook: '',
        continueFridayBook: '',
        continueSaturdayBook: '',
        continueSundayChapter: '',
        continueMondayChapter: '',
        continueTuesdayChapter: '',
        continueWednesdayChapter: '',
        continueThursdayChapter: '',
        continueFridayChapter: '',
        continueSaturdayChapter: '',
        plans: {},
        progress: {},
        todayDay: '',
        todayLong: '',
